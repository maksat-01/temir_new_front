...
interface IProps {
  productOne: IPropductsDetail
}

const CardsPremimum: FC<IProps> = ({ productOne }) => {
  //Класссы тегов
  const classesText =
  ...
  return (
    <section id="cards">
      <div className="container mx-auto pt-10">
        <div className="flex relative mt-20 py-2 max-md:flex-col">
          <div className={`${classesBefore}`}></div>
          <div className="cards__width">
            <div>
                ...
                {productAll.map((el) => (
                  ...
                  >
                    <div
                      ...
                      className="relative flex items-center justify-center w-[200px] max-xl:w-[150px] m-1"
                    >
                      <img
                        src={el.image}
                        alt=""
          ...
          <div className="cards__width m-auto relative overflow-hidden">
        ...
        <div className="max-w-[520px]">
          ...
          <div className="my-3">
            ...
            <div className="w-[65%] cursor-pointer bg-[rgba(54,54,56,0.5)] shadow-[0px_2px_10px_rgba(0,0,0,0.25)] px-2 py-3 text-[16px] text-[rgba(255,255,255,0.27)] rounded-[10px]">
              <input
                onChange={handleChange}
                id="input_file"
                type="file"
          ...
          <div className="flex py-6">
            <button
              ...
              className="bg-[#0B0B0B] shadow-[-10.93px_-8.94274px_20.8664px_rgba(72,72,72,0.25),5.96183px_6.95546px_20.8664px_#000000] rounded-[5px] font-[Jura] text-[30px] py-2 px-10 transition ease-linear hover:scale-[1.1] active:opacity-50"
            >
              Add to cart
            </button>
          </div>

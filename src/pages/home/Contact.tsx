  ...
  return (
    <section className="bg-[rgba(16,16,16,1)]">
      <div className="container mx-auto max-md:w-[90%]">
        <form
          className="contacts flex items-center content-center flex-col pt-16 pb-5 text-left"
          onSubmit={handleSubmit(onSubmit)}
        >
          <h1 className="font-bold text-4xl tracking-wide text-white py-10 text-center">
            Contact us
          </h1>
          <div className="flex flex-col mb-7 max-sm:w-[80%]">
            ...
            />
            {errors.full_name && (
              <span className="text-red-500 text-[12px] font-[Jura]">
          ...
          <div className="flex flex-col mb-7 max-sm:w-[80%]">
            ...
            <textarea
              ...
              placeholder="Felix Chan..."
              className={`${classesInput} min-h-[40px]`}
            />
            {errors.message && (
              <span className="text-red-500 text-[12px] font-[Jura]">
          ...
          <button
            className="w-56 h-14 bg-black font-normal text-lg text-white my-5 rounded-md hover:scale-110 hover:bg-transparent transition duration-500 ease-in-out"
            style={{
              boxShadow:
